...
const axiosNotMsgInstance = axios.create({
        baseURL: baseURL,
    ...() => {
...
;
axiosNotMsgInstance.interceptors.request.use(
    (config: any) => {
...
axiosNotMsgInstance.interceptors.response.use(
...
export default axiosNotMsgInstance;
